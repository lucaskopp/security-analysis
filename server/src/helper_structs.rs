...
pub struct IncomeStatement {
    ...
    pub research_and_developement_expenses: Option<f64>,
...
pub struct BalanceSheetStatement {
    pub date: String,
    pub cash_and_cash_equivalent: Option<f64>,
    ...
    pub total_liabilites_and_stockholders_equity: Option<f64>,
    pub minority_interest: Option<f64>,
    pub total_liabilties_and_total_equity: Option<f64>,
...
pub struct CashFlowStatement {
    pub date: String,
    pub net_income: Option<f64>,
    pub deprectiation_and_amortization: Option<f64>,
    ...
    pub net_cash_provided_by_operating_activites: Option<f64>,
    ...
    pub net_cash_used_provided_by_financing_activites: Option<f64>,
...
pub struct RatiosTTM {
    ...
    pub ebt_per_revenue_TTM: Option<f64>,
    ...
    pub eceivables_turnover_TTM: Option<f64>,
    ...
    pub price_to_free_cash_flow_ratio_TTM: Option<f64>,
...
pub struct KeyMetrics {
    ...
    pub ev_to_free_cash_yield: Option<f64>,
    ...
    pub research_and_developement_to_revenue: Option<f64>,
    pub intagibles_to_total_assets: Option<f64>,
    ...
    pub days_sales_oustanding: Option<f64>,
...
pub struct KeyMetricsTTM {
    ...
    pub ev_to_free_cash_yield_TTM: Option<f64>,
    ...
    pub intagibles_to_total_assets_TTM: Option<f64>,
    ...
    pub days_sales_oustanding_TTM: Option<f64>,
